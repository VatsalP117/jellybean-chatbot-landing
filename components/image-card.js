...
export default function ImageCard({ imgName, title, body }) {
  //h-48 sm:h-auto sm:w-48 md:w-64 flex-none bg-cover bg-center rounded rounded-t sm:rounded sm:rounded-l text-center overflow-hidden bg-[url('../public/wine.jpg')]
  console.log(imgName);
  return (
